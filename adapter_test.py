...
from adapter import stringify_lst_to_card_lst, card_lst_to_stringify_lst, hand_info_to_dict
from hand import Hand, HandInfo
class AdapterTest(unittest.TestCase):
  def test_stringify_lst_to_card_lst(self):
    ...
    self.assertEqual(stringify_lst_to_card_lst(stringify_lst), card_lst)
